...
export class MeshTransmissionMaterial extends THREE.MeshPhysicalMaterial {
  constructor({
    ...
    this.uniforms = {
      ...
      // Workaround used instead of .transmission in the shader
      _transmission: { value: _transmission },
      transmissionMap: { value: transmissionMap },
      // MeshPhysicalMaterial roughness default is 1 but that’s not great for glass
    ...
    this.onBeforeCompile = (shader) => {
      ...
      // Otherwise force USE_TRANSMISSION (three may not inject it for us)
